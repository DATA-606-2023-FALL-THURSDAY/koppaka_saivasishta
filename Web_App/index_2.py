...
def download_model_from_google_drive(gdrive_url, filename):
    # Extract the Google Drive file ID from the provided URL
...
def predict(img):
    ...
    model_gdrive_url = "https://drive.google.com/file/d/1fzBFTd--43GzgvI_DL7MGaYOw7l-3_FR/view?usp=drive_link"
    model_filename = "covid_model_v4.h5"
    download_model_from_google_drive(model_gdrive_url, model_filename)
